...
class VisualizationGltfCLI(ce.CmdParser):
    ...
    def define_name(self):
        ...
        self._name = 'visualization_mollweid'

    def define_description(self):
        """Define a description of this pipeline."""
        self._description = ('T1-Freesurfer and PET-Surface data saved fsaverage space projected in 2D using Mollweid projection')
    ...
    def run_command(self, args):
        ...
        from .visualization_mollweid_pipeline import VisualizationMollweid
        ...
        pipeline = VisualizationMollweid(
